...
**Answer: This dataframe has information organized by state, with a separate row for each of the 50 states. It has five columns with information regarding the amount spent per student in 2021, the GDP growth in 2021, the population change in 2021, and the winner of the 2020 presidential election in that state.**
...
**Answer: While there is a positive correlation between GDP growth and population change in 2021, it is a fairly weak correlation considering the data points are quite scattered.**
...
**Answer: There is a negative correlation between GDP growth and amount spent per pupil in 2021, but it is very slight so there is likely not much of a relationship between these two.**
...
**Answer: The per-pupil spending has a very weak negative relationship to the GDP growth at greater than -0.1 and has a slightly stronger negative relationship to population change at -0.41. Population change and GDP growth have a slight positive relationship at 0.21.**
...
**Answer:** **This output shows the t-value, df, p-value and correlation in addition to other information such as the alternative hypothesis and the 95 percent confidence interval. The p-value is very low at 0.00301, and the correlation is -0.4112291.**
...
**Answer: This output shows a weaker correlation at -0.05989652. It also has a larger p-value at 0.6795, which indicates that these results are not statistically significant.**
...
**Answer: States who voted for Biden had a higher average GDP growth and more funding per pupil. States who voted for Trump had a higher average increase in population.**
...
**Answer: This shows the mean population change for Trump and Biden, and the p-value of 0.07411 indicates that these results may not be statistically significant since it is slightly greater than 0.05.**
...
**Answer: For the funding per pupil, the results are much more likely to be significant since the p-value was very low at 0.0001289. The t-value is also stronger at 4.2494.**
