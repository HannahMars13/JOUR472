...
**Answer: It took the first row of the data and is using it as the column names.**
...
**Answer: The column names need to be fixed so that it is clear what each column actually means since R just put placeholder numbers in each column name. Also, there are still all the extra periods in the first column.**
...
**Answer: The last thing to fix is the periods in the first column, which should all be removed to make it look cleaner.**
