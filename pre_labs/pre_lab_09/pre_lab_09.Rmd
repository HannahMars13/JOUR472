...
<https://datawrapper.dwcdn.net/QhD4j/1/>
...
**Answer** Describe the changes from the previous map: **Previously, it showed the whole country, but there was no data shown anywhere except in Maryland. Now it only has the state of Maryland, and it does include any of the neighboring states.**
...
**Answer** Describe the changes from the previous map: **Before, when we hovered over the counties, it had the fips code, which is not meaningful to the reader, and the percent in the form of a number with many decimal points. Now when we hover over each county, it says the name of the county and a formatted percentage.**
...
<https://datawrapper.dwcdn.net/36jNw/1/>
