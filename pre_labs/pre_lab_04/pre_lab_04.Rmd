...
**Answer: Some of the grantee names have variations on how they are spelled/which words in the name are abbreviated, which is preventing some grantees from being counted properly since each spelling variation is counted as a completely different grantee.**
...
**Answer: It changed "Charles County Arts Alliance Inc" to "CHARLES COUNTY ARTS ALLIANCE", and it changed "The Tree House Child Advocacy Center of Montgomery County MD Inc." to be in all-caps.**
...
**Answer: It changed "WASHINGTON ADVENTIST UNIVERSITY" so that only the first letter of each word is capitalized. It changed** **"WASHINGTON CO COMM. ACTION COUNCIL INC" to "WASHINGTON COMM ACTION COUNCIL", removing the period after "COMM" as well as the word "INC". Also, like the first example, it changed "WASHINGTON COLLEGE" so that only the first letter of each word is capitalized.**
...
**Answer: Looking at the first few pages, there is not a substantial difference between the way in which this function cleaned the data as compared to the key_collision_merge function. The two seem to have made many of the same changes to the data.**
