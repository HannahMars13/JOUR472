...
**Answer:** Nevada has the largest percentage of growth at 35.15%.
...
**Answer:** Howard County has the highest median household income at \$129,549.
...
**Answer:** A better version would be "Estimated median household income per county in Maryland."
...
**Answer:** No, the difference between these two is not statistically significant because the bars overlap.

Is the difference between Howard and everyone else significant?

**Answer:** Yes, Howard County's margin of error does not overlap with any other counties.
...
**Answer:** The jurisdictions with the largest increases were Baltimore City and Allegancy County with increases of 37.42% and 35.35%, respectively. None of them saw a decrease, but Caroline County is at the bottom of the list with only a 7% increase.
...
**Answer:** We could find if there is a correlation between higher enrollment and higher median household income.
...
**Answer:** There is a large difference between these two, with a much higher average income for the schools with higher enrollment. There are also more schools that fall into the less than 40% category than the 60% category.
...
**Answer:** Another question would be to see how this has changed over time, which could be determined by pulling in extra data from other years.
