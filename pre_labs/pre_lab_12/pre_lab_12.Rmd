...
**Answer: It is a four-column dataframe, with the date, title, URL, and text.**
...
**Answer: It removes all duplicates so it's only a list of unique words. It is also case-sensitive.**
...
**Answer: It has now separated out the text to have one row per each word in a large one-column dataframe.**
...
**Answer: The resulting graphic shows the number of times each unique word was used, but it is not currently the most interesting since most of the words that appear here are short ones that don't tell us much, such as "the," "that," and "with."**
...
**Answer: It is much more interesting without the stop words, for you can actually see from the frequency of words such as "health" and "funding" what kinds of topics were being discussed.**
...
**Answer: We can now see the top 10 words for each of these three years, and there definitely seem to be a lot that stay consistently very high on the list. Some words that appear on all three are "communities," "health," and "act."**
...
**Answer: We now have a list of two-word phrases, and many of these results are unsurprising and are somewhat related to the list of one-word phrases. It makes sense that "covid 19" and "19 pandemic" would appear quite frequently, as well as phrases such as "human rights" and "public health" since those are always popular topics.**
...
**Answer: In 2022 "covid 19" moved down the list a bit, but it was still in the top five. More locations are on the list now, with Prince George's County, Baltimore, and the Chesapeake Bay all be here and some of them even appearing multiple times on the list.**
...
**Answer: In 2023 "covid" was not on the list at all, and it is now more so phrases related to "rights" and certain types of policies.**
...
**Answer: I think there are some words that just seem as though they do not always produce that sentiment and can be categorized as the opposite sentiment depending on how the word is used. One such example is "critical," which was categorized as negative but could also just be referring to some measure as being a "critical" one to take. Also, the word "like" is categorized as positive, but this does not account for when it is used as a word of comparison.**
